...
<div class="form-structor">
	<div class="signup">
		<h2 class="form-title" id="signup">Editar Autor</h2>
        <form action="update_autores.php" method="post">
    ...
    if(isset($_GET['x'])) {
        ...
        if ($res) {
                while($row = mysqli_fetch_assoc($res)) {
                    echo '<input type="hidden" class="input fav" name="id" value="'.$row["autor_id"].'" />';
                    echo '<input type="text" class="input fav" name="nombre" value="'.$row["nombre"].'" />';
                    echo '<input type="text" class="input fav" name="apellido_paterno" value="'.$row["apellido_paterno"].'" />';
                    echo '<input type="text" class="input fav" name="apellido_materno" value="'.$row["apellido_materno"].'" />';
                }
          } else {
